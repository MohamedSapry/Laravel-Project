...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-08a5751a", Component.options)
  } else {
    hotAPI.reload("data-v-08a5751a", Component.options)
  }
...
var update = __webpack_require__(4)("5ed34d06", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-08a5751a\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./UserForm.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-08a5751a\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./UserForm.vue");
...
var render = function() {
  ...
  return _c("div", [
    ...
    _c("input", {
      ...
      on: {
        input: [
          ...
          function($event) {
            _vm.getUserNameFromInput(_vm.userName), _vm.findUsers()
          }
        ]
      }
    }),
    ...
    _vm.userName != ""
              ...
              "li",
              {
                ...
                on: {
                  click: function($event) {
                    _vm.setUserName(user.title), _vm.setUserId(user.id.value)
                  }
                }
              },
              [_vm._v("\n           " + _vm._s(user.title) + "\n       ")]
      ...
      : _vm._e(),
    _vm._v(" "),
    _c("label", { attrs: { for: "streetName" } }, [_vm._v(" Street Name ")]),
    _c("br"),
    _vm._v(" "),
    _c("input", {
      directives: [
      ...
      attrs: { type: "text", name: "", id: "streetName" },
      domProps: { value: _vm.streetName },
      on: {
        input: [
          function($event) {
            if ($event.target.composing) {
            ...
            _vm.streetName = $event.target.value
          },
          function($event) {
            return _vm.setStreetName(_vm.streetName)
          }
        ]
      }
    }),
    _c("br"),
    _vm._v(" "),
    _c("label", { attrs: { for: "buildingNumber" } }, [
      _vm._v(" Building Number ")
    ]),
    _c("br"),
    _vm._v(" "),
    _c("input", {
      ...
      attrs: { type: "text", name: "", id: "buildingNumber" },
      domProps: { value: _vm.buildingNumber },
      on: {
        input: [
          function($event) {
            if ($event.target.composing) {
            ...
            _vm.buildingNumber = $event.target.value
          },
          function($event) {
            return _vm.setBuildingNumber(_vm.buildingNumber)
          }
        ]
      }
    }),
    ...
    _c("br"),
    _vm._v(" "),
    _c("label", { attrs: { for: "apartmentNumber" } }, [
      ...
      directives: [
        {
          name: "model",
          rawName: "v-model",
          value: _vm.apartmentNumber,
          expression: "apartmentNumber"
        }
      ],
      attrs: { type: "text", name: "", id: "apartmentNumber" },
      domProps: { value: _vm.apartmentNumber },
      on: {
        input: [
          function($event) {
            if ($event.target.composing) {
            ...
            _vm.apartmentNumber = $event.target.value
          },
          function($event) {
            return _vm.setapartmentNumber(_vm.apartmentNumber)
          }
        ]
      }
    }),
    ...
    _c("input", {
      ...
      on: {
        input: [
          ...
          function($event) {
            _vm.getCityNameFromInput(_vm.city), _vm.findCities()
          }
        ]
      }
    }),
          ...
          _vm._l(_vm.cities, function(city, index) {
            return _c(
              "li",
              {
                ...
                on: {
                  click: function($event) {
                    _vm.setCityName(city.fields[1].value),
                      _vm.setAreaId(city.fields[0].value)
                  }
                }
              },
              [
                _vm._v(
                  "\n           " + _vm._s(city.fields[1].value) + "\n       "
                )
              ]
            )
          }),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-08a5751a", module.exports)
  }
}
...
var store = {
    ...
    state: (_state = {
        ...
        userId: null,
        areaId: null
    }, _defineProperty(_state, 'userName', null), _defineProperty(_state, 'streetName', null), _defineProperty(_state, 'buildingNumber', null), _defineProperty(_state, 'floor', null), _defineProperty(_state, 'apartmentNumber', null), _defineProperty(_state, 'city', null), _defineProperty(_state, 'cities', []), _state),
    mutations: {
        listUsers: function listUsers(state, usersNames) {
            state.userNames = usersNames;
            console.log(state.userNames);
        },
        listCities: function listCities(state, citiesNames) {
            state.cities = citiesNames;
            console.log(state.cities);
        },
        getUserNameFromInput: function getUserNameFromInput(state, userName) {
            console.log("get user name from input ");
            state.useName = userName;
        },
        getCityNameFromInput: function getCityNameFromInput(state, city) {
            state.city = city;
        },
        ...
        setAreaId: function setAreaId(state, areaId) {
            console.log("set AreaID : " + areaId);
            state.areaId = areaId;
        },
        setBuildingNumber: function setBuildingNumber(state, buildingNumber) {
            console.log("set Building number : " + buildingNumber);
            state.buildingNumber = buildingNumber;
        },
        setStreetName: function setStreetName(state, streetName) {
            console.log("set Street Name" + streetName);
            state.streetName = streetName;
        },
        setFloor: function setFloor(state, floor) {
            console.log("set Floor : " + floor);
            state.floor = floor;
        },
        setapartmentNumber: function setapartmentNumber(state, apartmentNumber) {
            console.log("set Apartment Number : " + apartmentNumber);
            state.apartmentNumber = apartmentNumber;
        }
    },
    actions: {
        findUsers: function findUsers(_ref) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__UserForm_vue__ = __webpack_require__(2);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: { UserForm: __WEBPACK_IMPORTED_MODULE_0__UserForm_vue___default.a },
